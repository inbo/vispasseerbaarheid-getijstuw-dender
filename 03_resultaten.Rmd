...
```{r rangebovenstuw, fig.cap="Stroomsnelheid over de stuw (V_o in m/s) un functie van de opening onder de stuw (h_u in m) voor verschillende debieten (m³/s).", fig.width=12, fig.height=16, out.width='100%', fig.align='center'}
