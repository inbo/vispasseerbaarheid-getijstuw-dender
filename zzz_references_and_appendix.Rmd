...
```{r roc_over_stuw1, fig.width=6, fig.height=5}
# set.seed(123)
...
```{r dtfreeflow, fig.width=6, fig.height=5}
# set.seed(123)
...
Wanneer water ongehinderd kan stromen over de stuw dan is deze passeerbaar wanneer het totaal debiet lager ligt dan 133 m³/s.

```{r dtfreeflowover, fig.width=6, fig.height=5}
# set.seed(123)
